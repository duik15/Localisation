...
outName = 'OffSet23_voc3_Ns2e14_150-200hz_boat1minute';
...
% Figure parameters
showFig = [1 2 3 7]%1 2 3 4 5 6 7]; %7 9]%[1 2 3 4 7];% [1:7];% Figure number to print
