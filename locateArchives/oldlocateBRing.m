...
% Path information
addpath(genpath('../cedBeamForming/'))
folderIn = '~/Documents/MPO/BRing/Data/wav/CD_circle/'; 
%folderIn = 'Z:\DATA\missions\2021-07-27_IML_2021-016_BRings\wav\';   
folderOut = './results/testCDLoc/';

% Loading files
[ploc, ptime ]  = getPingLoc('ccd'); % Load ping information
fileList = getWavName(ptime, folderIn);
...
% Loading part
file_wav = fileList{1};
[MAT_s,fe, tstart, dura] = bringRead([folderIn fileList{i}], ptime(i),'duration',3,'buffer',0,'power2',true);
