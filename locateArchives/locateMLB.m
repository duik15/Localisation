...
outName = 'OffSet23_voc3_Ns2e14_150-200hz_AvCircle';
...
% Figure parameters
saveData = false;
showFig = [7]%1 2 3 4 5 6 7]; %7 9]%[1 2 3 4 7];% [1:7];% Figure number to print
...
offset = - 78 * pi /180; %(90 + 25) * pi / 180;  % Av = (90-67) CD  =
