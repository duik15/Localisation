...
outName = 'OffSet97_voc1_5_Ns2e17_fl50fh100_cdCircle';
...
% Figure parameters
showFig = [2 3 7]; %7 9]%[1 2 3 4 7];% [1:7];% Figure number to print
printFig = true;    % Saving figure to a folder
nbPk = 4 ;          % Nomber of side lobe to keep

% Reading parameters
Ns = 2^17;              % Total number of sample
...
offset = 97  * pi /180; %(90 + 25) * pi / 180;  % Av = (90-67) CD  =
...
%% Saving data
save([folderOut 'locateBRING_Data_' outName '.mat'],'angleM','angleA','matEnergie')
