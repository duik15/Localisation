...
folderIn = '~/Documents/MPO/BRing/Data/wav/PRC/';
%folderIn = 'Z:\DATA\missions\2021-07-27_IML_2021-016_BRings\wav\';
outName = 'xysc_OffSet135_voc3_Ns2e15_PRCCircle';
folderOut = ['/Users/Administrator/Documents/MPO/BRing/Data/results/PRC/' outName '/'];

% Loading files and time
% Or give an array of time to process ptime = [datetime(xxx),datetime(xxx)]
[ploc, ptime ]  = getPingLoc('cpc'); % Load ping information
ptime = ptime ;
...
% Figure parameters
showFig = [1 2 3 7] %7 9]%[1 2 3 4 7];% [1:7];% Figure number to print
printFig = true;    % Saving figure to a folder

% Reading parameters
Ns = 2^15;              % Total number of sample
...
aMax2 = aMax -90;
aMax3= aMax2;
aMax3(aMax2<0) = 360  + aMax2(aMax2<0)

[a3sort, i3sort] = sort(aMax);

figure(7)
plot(aMax3,'--ok')
xlabel('Ping number')
ylabel('Angle of arrival')
print([folderOut 'angleOfArrival90_' outName '.png'],'-r150','-dpng')
