...
moreInfo = 'narw0716T1903';
arrID = {'CLD','AAV'};  
%dtime = [ datetime(2021,07,15, 09, 52, 27); datetime(2021,07,15, 09, 52, 25)];
dtime = [ datetime(2021,07,14, , 19, 03); datetime(2021,07,16, 06, 18, 56)];
...
spgm.im.freqlims = [80 200];       % [Hz] frequency scale boundary limits
spgm.im.clims = [30 60];           % [dB] C limite pcolorspgm.im.clims = [30 60];           % [dB] C limite pcolor
