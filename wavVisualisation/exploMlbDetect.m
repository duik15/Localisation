...
% Exploration vector
%load(['/Users/Administrator/Documents/MPO/BRing/Data/wav/' 'DETECT_NARW_MLB_PR_V1.mat'])
file2Detect =['Z:\DATA\missions\2021-07-27_IML_2021-016_BRings\results\Detections_manuelles\' 'DETECT_NARW_MLB_PR_V1.mat'];
D = load(file2Detect);
nbF = numel(D.dtime);
